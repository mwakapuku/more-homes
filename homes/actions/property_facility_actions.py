...
def create_property_cost(property_costs, property_instance):
    if property_costs:
        for property_cost in property_costs:
            name = property_cost.get("name")
            amount = property_cost.get("amount")
